...
$(document).ready(function(){
	...
	$(".form-control").focus(function(){
		...
		var _this = $(this);
		_this.parent('.formError').removeClass('has-error');
		_this.siblings('span').html('');
	...
	$(".clear").click(function(){
		...
		$(".formError").removeClass("has-success");
		
		$(".formError").each(function(i,v){
	...
	$(".send").click(function(){
		...
		if($.trim(firstName) == "" || $.trim(lastName) == "" || $.trim(email) == "" || $.trim(subject) == "" || $.trim(message) == "" || !validateEmail(email))
		{
			if($.trim(firstName) == "")
			{
				$(".firstNameError").html('<p style="color:#a94442;">First name is required!</p>');
				$(".firstNameError").parent('div').addClass('has-error');
			}
			
			if($.trim(lastName) == "")
			{
				$(".lastNameError").html('<p style="color:#a94442;">Last name is required!</p>');
				$(".lastNameError").parent('div').addClass('has-error');
			}
			
			if(!validateEmail(email))
			{
				$(".emailError").html('<p style="color:#a94442;">Email is invalid!</p>');
				$(".emailError").parent('div').addClass('has-error');
			}
			
			if($.trim(email) == "")
			{
				$(".emailError").html('<p style="color:#a94442;">Email is required!</p>');
				$(".emailError").parent('div').addClass('has-error');
			}
			
			if($.trim(subject) == "")
			{
				$(".subjectError").html('<p style="color:#a94442;">Subject is required!</p>');
				$(".subjectError").parent('div').addClass('has-error');
			}
			
			if($.trim(message) == "")
			{
				$(".messageError").html('<p style="color:#a94442;">Message is required!</p>');
				$(".messageError").parent('div').addClass('has-error');
			}
			
			return;
		}
		
		$(".formError").addClass('has-success');
		$(".feedbackForm").hide();
		...
		var link = 'mailto:email@example.com?subject='+subject+
            '&body='+body;
